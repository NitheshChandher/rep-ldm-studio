"""
This code snippet is adapted from an unofficial implementation of diffusion autoencoder (https://github.com/khokao/diffusion-autoencoders),
which itself is based on the original diffusion autoencoder implementation (https://github.com/phizaz/diffae).
